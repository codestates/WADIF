...
const SignUpAndSignIn = () => {
  ...
  const SignUpSubmit = (e) => {
    ...
    if (
      checkUserIdSU(id) &&
      checkEmailSU(email) &&
      checkPasswordSU(password) &&
      checkPassword2SU(password, password2)
    ) {
          ...
          <div className="formBx">
            <form>
              ...
              <div className="errMessage">
                <div>
                  <span className={`${errStateOfIdSI}`}>
                    아이디 또는 비밀번호가 잘못 입력 되었습니다.
                  </span>
                  <br />
                  <span className={`${errStateOfPasswordSI}`}>
        ...
        <div className={`user signUpBx ${signUpState}`}>
          <div className="formBx">
            <form>
              ...
              <input type="text" placeholder="Id" ref={idSURef} />
              <input type="text" placeholder="Email Address" ref={EmailSURef} />
              <input
                type="password"
              ...
              <div className="errMessage">
                <div>
                  <span className={`${errStateOfId}`}>
                    아이디는 영문 대소문자와 숫자 4~12자리로 입력해야합니다.
                  </span>
                  <span className={`${errStateOfEmail}`}>
                    잘못된 이메일 형식 입니다.
                  </span>
                  <span className={`${errStateOfPassword}`}>
                    비밀번호는 영문 대소문자와 숫자 6~12자리로 입력해야합니다.
                  </span>
                  <span className={`${errStateOfPassword2}`}>
                    두 비밀번호가 맞지 않습니다.
                  </span>
                </div>
              </div>
